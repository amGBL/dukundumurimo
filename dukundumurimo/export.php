...
<body>
	...
	<div class="container">
		<div class="form">
			<form action="export_check.php" method="POST">
				<?php

			if (isset($_GET['error'])) {
				?>
		<div class="alert alert-danger">
  			<p><strong>warning: </strong><?php  echo $_GET['error']?></p>
		</div>
			...
			<div>
				<input type="date" name="date" placeholder="export_date" required style="width: 405px;">
			</div>
			<div>
